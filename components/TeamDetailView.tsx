...
export const TeamDetailView: React.FC<TeamDetailViewProps> = ({ 
    team, schedule, league, onGameSelect, selectedGameId, prediction, gameDetails, isPredicting, isDarkMode = true, onGenerateAnalysis, onTeamClick
}) => {
