...
import { Game, GameDetails, GameSituation } from '../../types';
...
export const FootballField: React.FC<FieldProps> = ({ situation, homeTeam, awayTeam, game, isDarkMode, compact, gameDetails }) => {
